...
public class World extends Agent{
	...
	protected void setup() {
		...
		// Lets say this is the time it takes for a rover to move
			...
			public void action() {
				...
				if (msg == null) return;
					...
					if (msg.getProtocol() == ontology.PROTOCOL_ROVER_MOVEMENT) {
						...
						System.out.println(myAgent.getLocalName() + " remove movement of " + (msg.getSender()).getLocalName());
						doWait(1500);
					}
	...
	protected String[][] readMap() throws Exception{
		...
		String[][] map = null;
		BufferedReader reader = new BufferedReader(new FileReader("/Users/Vinu/Documents/NetBeansProjects/XplorationGit/src/main/java/es/upm/map/map.txt"));
